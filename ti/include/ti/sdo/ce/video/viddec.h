 ...
 *
 *  @brief      The 0.9 Video Decoder Codec Interface.  Provides the user an
 *              interface to create and interact with xDAIS algorithms that are
 *              compliant with the xDM 0.9 video decoder interface.
 */
/**
 *  @defgroup   VIDDEC    0.9 Video Decoder Codec Interface
 *
 *  This is the 0.9 video decoder codec interface.  Several of the data
 ...
 *              instance of a 0.9 video decoder object.
 */
...
/**
 *  @brief      Definition of IVIDDEC codec class configurable parameters
 */
 ...
 *              buffer alignment.
 *
 *  @sa         VIDDEC_create(), VIDDEC_delete(), VIDDEC_control()
 */
 ...
 *
 *  @sa         VIDDEC_create(), VIDDEC_delete()
 */
