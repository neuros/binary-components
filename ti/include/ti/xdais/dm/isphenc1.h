 ...
 */
/**
 *  @defgroup   ti_xdais_dm_ISPHENC1   xDM 1.00 Speech/Voice Encoder Interface
 *
 ...
 *              with the optional exception of @c inArgs->data.
 *
 ...
 *  @retval     ISPHENC1_ENOOUTPUT      @copydoc ISPHENC1_ENOOUTPUT
 */
